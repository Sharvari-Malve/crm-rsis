              ...
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-3 flex items-center space-x-3">
                  ...
                  <label className="inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-teal-600 relative after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:w-5 after:h-5 after:bg-white after:rounded-full after:transition-all peer-checked:after:translate-x-5"></div>
                  </label>
                </td>
              </tr>
            ))}
          ...
          <div className="bg-white w-[500px] shadow-2xl border border-gray-300 rounded-xl">
            ...
            <div className="p-6 space-y-4">
              <input
                ...
                className={`w-full border px-3 py-2 rounded-lg ${errors.username ? "border-red-500" : ""}`}
              />
              ...
              <input
                ...
                className={`w-full border px-3 py-2 rounded-lg ${errors.mobile ? "border-red-500" : ""}`}
              />
            ...
            <div className="px-6 py-4 border-t bg-gray-50 flex justify-end space-x-3 rounded-b-xl">
              ...
              <button onClick={handleSaveUser} className="px-5 py-2 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-lg">
                Save
              </button>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center">
          <div className="bg-white w-[500px] shadow-2xl border border-gray-300 rounded-xl">
            ...
            <div className="px-6 py-4 border-t bg-gray-50 flex justify-end space-x-3 rounded-b-xl">
              ...
              <button onClick={confirmDeleteUser} className="px-5 py-2 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg">
                Delete
              </button>
            </div>
          </div>
